      ...
      <>
        ...
        <div className="min-h-screen bg-[#0a0e1a] flex items-center justify-center px-6">
          <div className="text-center">
            <div className="w-20 h-20 mx-auto mb-6 bg-[#0d1321] border border-white/10 flex items-center justify-center">
            ...
            <WalletMultiButton className="!bg-[#14F195] !text-[#0a0e1a] !rounded-none !px-8 !py-3 !font-semibold hover:!bg-[#0ed184]" />
          </div>
        </div>
      </>
    );
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row lg:items-start gap-8 mb-12">
              ...
              <div className="flex flex-col items-center lg:items-start">
                <div className="w-24 h-24 bg-[#14F195] flex items-center justify-center mb-4">
                  <span className="text-4xl">👨‍🎓</span>
                </div>
                <span className="px-4 py-1.5 bg-[#14F195]/10 text-[#14F195] text-sm font-medium border border-[#14F195]/20">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/40 mb-8">Joined December 2025</p>

                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {[
                    { value: USER_DATA.xp.toLocaleString(), label: 'Total XP', color: 'text-[#14F195]' },
                    ...
                    <div key={stat.label} className="bg-[#0d1321] border border-white/10 p-4">
            ...
            {/* XP Progress */}
            <div className="bg-[#0d1321] border border-white/10 p-6 mb-8">
              ...
              <div className="h-2 bg-white/5 rounded-sm overflow-hidden">
                <div 
                  className="h-full bg-[#14F195] rounded-sm transition-all duration-500"
              ...
              {activeTab === 'courses' ? (
                <div className="space-y-4">
                  {USER_DATA.enrolledCourses.map((course) => (
                    <div key={course.id} className="bg-[#0d1321] border border-white/10 p-6">
                  ...
                  <Link 
                    href="/"
                    className="flex items-center justify-center gap-2 py-4 border border-dashed border-white/10 text-white/40 hover:text-white/60 hover:border-white/20 transition-colors"
                  >
